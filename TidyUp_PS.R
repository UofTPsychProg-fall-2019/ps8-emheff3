...
#These variables already appear to be marked as NA, but if I wanted to change them I would do this:

#tbl_clean$gender <- na_if(tbl_clean$gender, '-1')
...
#F = female, M = male, GC/NC = genderqueer/nonconforming, other = all other responses
